...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Для полноэкранного режима работы
    ...
    def run_game(self):
        ...
        while True:
            ...
            if self.stats.game_active:
                ...
                self._update_aliens()       # Изменение положения пришельцев
    ...
    def _create_fleet(self):
        ...
        """Определяет кол-во рядов, помещающихся на экран"""
